...
<p align="center">
      LATEST FB WITHOUT LOGIN NEW TOOLS
</p>
...
$ pip2 install bs4
$ pkg install git
$ git clone https://github.com/James404-cyber/NOLOGIN.git
$ cd NOLOGIN
$ python2 Nologin.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/NOLOGIN.git ; cd NOLOGIN ; python2 Nologin.py
```
